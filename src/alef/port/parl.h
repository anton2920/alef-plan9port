...
enum
{
	...
	MARITH		= (MINT|MUINT|MSINT|MSUINT|MCHAR|MFLOAT|MLINT|MLUINT),
	MUNSIGNED	= (MCHAR|MUINT|MSUINT|MIND|MLUINT),
	MBOOL		= (MARITH|MIND),
	MSCALAR		= (MARITH|MIND),
	MINCDEC		= (MINT|MUINT|MSINT|MSUINT|MCHAR|MIND|MLINT|MLUINT),
	MCOMPLEX	= (MADT|MUNION|MAGGREGATE),
	MCONVIND	= (MINT|MUINT|MIND),
	MINTEGRAL	= (MINT|MUINT|MSINT|MSUINT|MCHAR|MLINT|MLUINT),
};
